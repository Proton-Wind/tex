...
\item 以下の問いに答えよ。
	\begin{enumerate}
		\item ~~
			\begin{mawarikomi}(10pt,0pt){120pt}{\input{./fig/1期fig01.tex}}
				右図のように長さ0.80{\sf m}の軽い棒の両端に，質量2.0{\sf kg}の小球Aと質量3.0{\sf kg}の小球Bを固定した。小球Aから重心までの距離は何{\sf m}か。ただし，小球の大きさは無視する。	\\
			\end{mawarikomi}
			\item ~~
			\begin{mawarikomi}(10pt,0pt){120pt}{\input{./fig/1期fig02.tex}}
...
\item 次の(1)，(2)のような厚さ，密度が一様な板がある。(1)は左端を原点として，重心の$x$座標を，(2)は，左下端を原点として，重心の$x$座標，$y$座標をそれぞれ求めよ。
		\begin{edaenumerate}
			\item ~~\\
				\input{./fig/1期fig03.tex}
			\item ~~\\
				\input{./fig/1期fig04.tex}
		\end{edaenumerate}
\vfill
\newpage
\item ~~
		\begin{mawarikomi}{160pt}{\input{./fig/1期fig07.tex}}
...
\vfill
%\item ~~
%		\begin{mawarikomi}{160pt}{\input{./fig/1期fig08.tex}}
...
%			\begin{enumerate}
%				\item 分離後の頭部Aの地面に対する速度を$v_\mathrm{A}$，尾部Ｂの地面に対する速度を$v_\mathrm{B}$として，$v_\mathrm{A}$，$v_\mathrm{B}$，$u$の関係を示せ。
%				\item 頭部Ａの地面に対する速度$v_\mathrm{A}$\tanni{m/s}を求めよ。
%			\end{enumerate}
%		\end{mawarikomi}
%\vfill
\item ~~
		\begin{mawarikomi}(20pt,0pt){160pt}{\input{./fig/1期fig05.tex}}
...
\vfill
\item ~~
		\begin{mawarikomi}(10pt,0pt){180pt}{\input{./fig/1期fig09.tex}}
...
\newpage
\item ~~
		\begin{mawarikomi}(20pt,0pt){160pt}{\input{./fig/1期fig06.tex}}
...
\vfill
\item ~~
		\begin{mawarikomi}(10pt,0pt){200pt}{\input{./fig/1期fig10.tex}}
...
\vfill
\item ~~
		\begin{mawarikomi}(10pt,0pt){160pt}{\input{./fig/1期fig11.tex}}
